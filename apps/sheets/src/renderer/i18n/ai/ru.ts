...
export const ru = {
  ...
  aiEmptyBuildBody: 'Опишите нужную таблицу, данные или диаграмму — ИИ создаст их на месте.',  aiUndelivered: 'Не отправлено',
  aiRetry: 'Повторить',
  ...
  aiAccountChecking: 'Проверка…',      aiModel: 'Модель',
  aiCancel: 'Отмена',
  aiSave: 'Сохранить',
