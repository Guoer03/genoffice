...
export const it = {
  ...
  aiEmptyBuildBody: 'Descrivi la tabella, i dati o il grafico che ti servono: l’IA li crea subito.',  aiUndelivered: 'Non inviato',
  aiRetry: 'Riprova',
  ...
  aiAccountChecking: 'Verifica in corso…',      aiModel: 'Modello',
  aiCancel: 'Annulla',
  aiSave: 'Salva',
