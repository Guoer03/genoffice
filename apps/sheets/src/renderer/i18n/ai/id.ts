...
export const id = {
  ...
  aiEmptyBuildBody: 'Jelaskan tabel, data, atau bagan yang Anda perlukan — AI langsung membuatnya.',  aiUndelivered: 'Tidak terkirim',
  aiRetry: 'Coba lagi',
  ...
  aiAccountChecking: 'Memeriksa…',      aiModel: 'Model',
  aiCancel: 'Batal',
  aiSave: 'Simpan',
