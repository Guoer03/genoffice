...
export const pt = {
  ...
  aiEmptyBuildBody: 'Descreva a tabela, os dados ou o gráfico que precisa — a IA cria na hora.',  aiUndelivered: 'Não enviado',
  ...
  aiAccountChecking: 'Verificando…',      aiModel: 'Modelo',
  aiCancel: 'Cancelar',
  aiSave: 'Salvar',
