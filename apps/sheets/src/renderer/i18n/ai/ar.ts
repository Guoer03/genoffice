...
export const ar = {
  ...
  aiEmptyBuildBody: 'صف الجدول أو البيانات أو المخطط الذي تريده — ينشئه الذكاء الاصطناعي مباشرة.',  aiUndelivered: 'لم يتم الإرسال',
  ...
  aiAccountChecking: 'جارٍ التحقق…',      aiModel: 'النموذج',
  aiCancel: 'إلغاء',
  aiSave: 'حفظ',
