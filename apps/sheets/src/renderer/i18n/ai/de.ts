...
export const de = {
  ...
  aiEmptyBuildBody:
    'Beschreibe die gewünschte Tabelle, Daten oder Diagramme — die KI erstellt sie direkt.',  aiUndelivered: 'Nicht gesendet',
  ...
  aiAccountChecking: 'Wird überprüft…',      aiModel: 'Modell',
  aiCancel: 'Abbrechen',
  aiSave: 'Speichern',
