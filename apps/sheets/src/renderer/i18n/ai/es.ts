...
export const es = {
  ...
  aiEmptyBuildBody:
    'Describe la tabla, los datos o el gráfico que necesitas: la IA los crea directamente.',  aiUndelivered: 'No enviado',
  aiRetry: 'Reintentar',
  ...
  aiAccountChecking: 'Comprobando…',      aiModel: 'Modelo',
  aiCancel: 'Cancelar',
  aiSave: 'Guardar',
