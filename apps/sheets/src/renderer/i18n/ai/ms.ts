...
export const ms = {
  ...
  aiEmptyBuildBody: 'Terangkan jadual, data atau carta yang anda perlukan — AI terus menciptanya.',  aiUndelivered: 'Tidak dihantar',
  aiRetry: 'Cuba lagi',
  ...
  aiAccountChecking: 'Sedang menyemak…',      aiModel: 'Model',
  aiCancel: 'Batal',
  aiSave: 'Simpan',
