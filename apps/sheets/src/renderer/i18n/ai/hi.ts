...
export const hi = {
  ...
  aiEmptyBuildBody: 'जो तालिका, डेटा या चार्ट चाहिए बताएँ — AI उसे तुरंत बना देता है।',  aiUndelivered: 'भेजा नहीं गया',
  ...
  aiAccountChecking: 'जांच हो रही है…',      aiModel: 'मॉडल',
  aiCancel: 'रद्द करें',
  aiSave: 'सहेजें',
