...
export const th = {
  ...
  aiEmptyBuildBody: 'อธิบายตาราง ข้อมูล หรือแผนภูมิที่ต้องการ แล้ว AI จะสร้างให้ทันที',  aiUndelivered: 'ส่งไม่สำเร็จ',
  aiRetry: 'ลองอีกครั้ง',
  ...
  aiAccountChecking: 'กำลังตรวจสอบ…',      aiModel: 'โมเดล',
  aiCancel: 'ยกเลิก',
  aiSave: 'บันทึก',
