...
export const strings = {
  zh: {
    // Sidebar navigation
    navRecent: '最近',
    navStarred: '收藏',    cloudSearchPlaceholder: '搜索 {n} 个项目…',
    ...
    cloudSortRecent: '最近',
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',    cloudEmpty: '还没有网页端项目。',
    ...
    untitled: '未命名',
    noContent: '（无内容）',
    // Account    account: '账号',            waitingShort: '等待登录…',                            appVersion: '版本 {v}',
    versionLabel: '版本',
    updateChannel: '更新通道',
    channelStable: '稳定版',
    channelBeta: 'Beta 版',
    ...
    setAiBaseUrlHint: '留空使用官方端点。',    setAiCodexPath: 'Codex 可执行文件',
    ...
    setSecAiMedia: '生图、媒体与搜索',    setAiImageModel: '生图模型',
    setAiAnalysisModel: '解析模型',    setAiSearchSerperHint: 'Serper 用你的 key 同时提供网页与图片搜索。',
    setAiSearchTavilyHint: 'Tavily 用你的 key 提供网页搜索；图片搜索改用免费来源。',
    setAiCapImage: '生图',
    setAiCapAnalysis: '图片解析',
    setAiCapVideo: '视频解析',
    setAiCapSearch: '网络搜索',
    setAiSharedKeyHint: '同一服务商的 key 与 Base URL 在各项能力间共用，只需填一次。',    setAiGskToolsDesc:
    ...
    onbStarHint: '如果你喜欢 GenOffice，欢迎到 GitHub 给我们一个 Star。',        setChange: '更改',
    // Dates
    today: '今天',
    yesterday: '昨天',
    daysAgo: '{n}天前',
    ...
    onbTitle2: '这只是一个开始',
    onbBody2: 'GenOffice 目前处于 alpha 阶段。欢迎加入 GenTeam 群聊，分享反馈，一起塑造它的未来。',    onbJoinGenTeam: '加入 GenTeam',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
    onbStepAria: '第 {n} 页，共 {total} 页',
    onbTitle3: '人人免费',
    onbBody3: '无授权费用，无广告，无水印。',    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    navStarred: 'Starred',    cloudSubtitle:
    ...
    cloudRefresh: 'Refresh',    cloudEmpty: 'No web projects yet.',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',    account: 'Account',                            
    ...
    settings: 'Settings',    setSecGeneral: 'General',
    setSecAbout: 'About',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'Leave empty for the official endpoint.',    setAiCodexPath: 'Codex executable',
    ...
    setSecAiMedia: 'AI Media & Search',    setAiImageModel: 'Image model',
    setAiAnalysisModel: 'Analysis model',    setAiSearchSerperHint: 'Serper serves both web and image search with your key.',
    ...
    setAiSharedKeyHint:
      "A vendor's key and base URL are shared across capabilities; enter them once.",    setAiGskToolsDesc:
    ...
    onbStarHint: 'If you like GenOffice, give us a star on GitHub.',        setChange: 'Change',
    today: 'Today',
    yesterday: 'Yesterday',
    daysAgo: '{n}d ago',
    language: 'Language',
    ...
    onbBody2:
      'GenOffice is still in alpha. Join the group chat on GenTeam to share feedback and help shape what comes next.',    onbJoinGenTeam: 'Join GenTeam',
    onbSkip: 'Skip',
    onbNext: 'Next',
    onbStart: 'Get started',
    onbStepAria: 'Page {n} of {total}',
    onbTitle3: 'Free for everyone',
    onbBody3: 'No license fees. No ads. No watermarks.',    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    navRecent: '最近使用',
    navStarred: 'お気に入り',    cloudSubtitle:
    ...
    cloudSortOldest: '古い順',
    cloudRefresh: '更新',    cloudEmpty: 'Web のプロジェクトはまだありません。',
    ...
    untitled: '無題',
    noContent: '（内容なし）',
    // Account    account: 'アカウント',            waitingShort: 'サインイン待ち…',                            appVersion: 'バージョン {v}',
    versionLabel: 'バージョン',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: '空欄で公式エンドポイントを使用します。',    setAiCodexPath: 'Codex 実行ファイル',
    ...
    setSecAiMedia: 'AI メディアと検索',    setAiImageModel: '画像モデル',
    setAiAnalysisModel: '解析モデル',    setAiSearchSerperHint: 'Serper はあなたのキーで Web 検索と画像検索の両方を提供します。',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      '同じプロバイダーのキーと Base URL は各機能で共有されます。一度入力すれば済みます。',    setAiGskToolsDesc:
    ...
    starPromptLater: 'あとで',
    onbStarHint: 'GenOffice が気に入ったら、GitHub でスターをお願いします。',        setChange: '変更',
    // Dates
    today: '今日',
    yesterday: '昨日',
    daysAgo: '{n}日前',
    ...
    onbBody2:
      'GenOffice はまだアルファ版です。GenTeam のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',    onbJoinGenTeam: 'GenTeam に参加',
    onbSkip: 'スキップ',
    onbNext: '次へ',
    onbStart: 'はじめる',
    onbStepAria: '{total} ページ中 {n} ページ目',
    onbTitle3: 'すべての人に無料',
    onbBody3: 'ライセンス料なし、広告なし、透かしなし。',    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    navRecent: '최근 사용',
    navStarred: '즐겨찾기',    cloudSubtitle:
    ...
    cloudRefresh: '새로고침',    cloudEmpty: '아직 웹 프로젝트가 없습니다.',
    ...
    untitled: '제목 없음',
    noContent: '(내용 없음)',
    // Account    account: '계정',            waitingShort: '로그인 대기 중…',                            appVersion: '버전 {v}',
    versionLabel: '버전',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: '비워 두면 공식 엔드포인트를 사용합니다.',    setAiCodexPath: 'Codex 실행 파일',
    ...
    setSecAiMedia: 'AI 미디어 및 검색',    setAiImageModel: '이미지 모델',
    setAiAnalysisModel: '분석 모델',    setAiSearchSerperHint: 'Serper는 내 키로 웹 검색과 이미지 검색을 모두 제공합니다.',
    setAiSearchTavilyHint:
    ...
    setAiCapSearch: '웹 검색',
    setAiSharedKeyHint:
      '같은 제공자의 키와 Base URL은 모든 기능에서 공유되므로 한 번만 입력하면 됩니다.',    setAiGskToolsDesc:
    ...
    starPromptLater: '나중에',
    onbStarHint: 'GenOffice가 마음에 들면 GitHub에서 스타를 눌러 주세요.',        setChange: '변경',
    // Dates
    today: '오늘',
    yesterday: '어제',
    daysAgo: '{n}일 전',
    ...
    onbBody2:
      'GenOffice는 아직 알파 단계입니다. GenTeam 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',    onbJoinGenTeam: 'GenTeam 참여하기',
    onbSkip: '건너뛰기',
    onbNext: '다음',
    onbStart: '시작하기',
    onbStepAria: '총 {total}페이지 중 {n}페이지',
    onbTitle3: '모두에게 무료',
    onbBody3: '라이선스 비용 없음, 광고 없음, 워터마크 없음.',    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    navRecent: 'Récents',
    navStarred: 'Favoris',    cloudSubtitle:
    ...
    cloudRefresh: 'Actualiser',    cloudEmpty: 'Aucun projet web pour le moment.',
    ...
    untitled: 'Sans titre',
    noContent: '(vide)',
    // Account    account: 'Compte',            waitingShort: 'En attente…',                            appVersion: 'Version {v}',
    versionLabel: 'Version',
    ...
    settings: 'Paramètres',    setSecGeneral: 'Général',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'Laisser vide pour le point de terminaison officiel.',    setAiCodexPath: 'Exécutable Codex',
    setAiCodexPathHint:
    ...
    setSecAiMedia: 'Médias IA et recherche',    setAiImageModel: "Modèle d'image",
    setAiAnalysisModel: "Modèle d'analyse",    setAiSearchSerperHint:
    ...
    setAiSharedKeyHint:
      "La clé et l'URL de base d'un fournisseur sont partagées entre les capacités ; saisissez-les une seule fois.",    setAiGskToolsDesc:
    ...
    onbBody2:
      'GenOffice est encore en alpha. Rejoignez la discussion de groupe sur GenTeam pour partager vos retours et façonner la suite.',    onbJoinGenTeam: 'Rejoindre GenTeam',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
    onbStepAria: 'Page {n} sur {total}',
    onbTitle3: 'Gratuit pour tous',
    onbBody3: 'Pas de licence. Pas de publicité. Pas de filigrane.',    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    navRecent: 'Zuletzt verwendet',
    navStarred: 'Favoriten',    cloudSubtitle:
    ...
    cloudRefresh: 'Aktualisieren',    cloudEmpty: 'Noch keine Web-Projekte.',
    ...
    untitled: 'Unbenannt',
    noContent: '(leer)',
    // Account    account: 'Konto',            waitingShort: 'Warten…',                            appVersion: 'Version {v}',
    versionLabel: 'Version',
    ...
    settings: 'Einstellungen',    setSecGeneral: 'Allgemein',
    setSecAbout: 'Über',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'Leer lassen für den offiziellen Endpunkt.',    setAiCodexPath: 'Codex-Programmdatei',
    setAiCodexPathHint:
    ...
    setSecAiMedia: 'KI-Medien & Suche',    setAiImageModel: 'Bildmodell',
    setAiAnalysisModel: 'Analysemodell',    setAiSearchSerperHint: 'Serper liefert mit deinem Schlüssel Web- und Bildsuche.',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      'Schlüssel und Base URL eines Anbieters gelten für alle Fähigkeiten; einmal eintragen genügt.',    setAiGskToolsDesc:
    ...
    onbStarHint: 'Wenn Ihnen GenOffice gefällt, geben Sie uns einen Stern auf GitHub.',        setChange: 'Ändern',
    // Dates
    today: 'Heute',
    yesterday: 'Gestern',
    daysAgo: 'vor {n} Tagen',
    ...
    onbBody2:
      'GenOffice ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf GenTeam bei, um Feedback zu teilen und die Zukunft mitzugestalten.',    onbJoinGenTeam: 'GenTeam beitreten',
    onbSkip: 'Überspringen',
    onbNext: 'Weiter',
    onbStart: 'Loslegen',
    onbStepAria: 'Seite {n} von {total}',
    onbTitle3: 'Kostenlos für alle',
    onbBody3: 'Keine Lizenzgebühren. Keine Werbung. Keine Wasserzeichen.',    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    navRecent: 'Recientes',
    navStarred: 'Destacados',    cloudSubtitle:
    ...
    cloudRefresh: 'Actualizar',    cloudEmpty: 'Aún no hay proyectos en la web.',
    ...
    untitled: 'Sin título',
    noContent: '(vacío)',
    // Account    account: 'Cuenta',            waitingShort: 'Esperando…',                            appVersion: 'Versión {v}',
    ...
    settings: 'Configuración',    setSecGeneral: 'General',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'Deja vacío para usar el endpoint oficial.',    setAiCodexPath: 'Ejecutable de Codex',
    setAiCodexPathHint:
    ...
    setSecAiMedia: 'Medios de IA y búsqueda',    setAiImageModel: 'Modelo de imagen',
    setAiAnalysisModel: 'Modelo de análisis',    setAiSearchSerperHint: 'Serper ofrece búsqueda web y de imágenes con tu clave.',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      'La clave y la URL base de un proveedor se comparten entre capacidades; introdúcelas una sola vez.',    setAiGskToolsDesc:
    ...
    onbStarHint: 'Si te gusta GenOffice, danos una estrella en GitHub.',        setChange: 'Cambiar',
    // Dates
    today: 'Hoy',
    yesterday: 'Ayer',
    daysAgo: 'hace {n} días',
    ...
    onbBody2:
      'GenOffice aún está en alfa. Únete al chat grupal en GenTeam para compartir comentarios y ayudar a dar forma a lo que viene.',    onbJoinGenTeam: 'Unirse a GenTeam',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
    onbStepAria: 'Página {n} de {total}',
    onbTitle3: 'Gratis para todos',
    onbBody3: 'Sin licencias. Sin anuncios. Sin marcas de agua.',    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    navRecent: 'ล่าสุด',
    navStarred: 'รายการโปรด',    cloudSubtitle:
    ...
    cloudRefresh: 'รีเฟรช',    cloudEmpty: 'ยังไม่มีโปรเจกต์บนเว็บ',
    ...
    // Account    account: 'บัญชี',            waitingShort: 'กำลังรอ…',                            appVersion: 'เวอร์ชัน {v}',
    ...
    settings: 'การตั้งค่า',    setSecGeneral: 'ทั่วไป',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'เว้นว่างเพื่อใช้ปลายทางอย่างเป็นทางการ',    setAiCodexPath: 'ไฟล์ปฏิบัติการ Codex',
    ...
    setSecAiMedia: 'สื่อ AI และการค้นหา',    setAiImageModel: 'โมเดลสร้างภาพ',
    setAiAnalysisModel: 'โมเดลวิเคราะห์',    setAiSearchSerperHint: 'Serper ให้บริการค้นหาเว็บและภาพด้วยคีย์ของคุณ',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      'คีย์และ Base URL ของผู้ให้บริการเดียวกันใช้ร่วมกันทุกความสามารถ กรอกครั้งเดียวพอ',    setAiGskToolsDesc:
    ...
    onbStarHint: 'ถ้าชอบ GenOffice ฝากกดดาวให้เราบน GitHub ด้วยนะ',        setChange: 'เปลี่ยน',
    // Dates
    today: 'วันนี้',
    yesterday: 'เมื่อวาน',
    ...
    onbBody2:
      'GenOffice ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน GenTeam เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',    onbJoinGenTeam: 'เข้าร่วม GenTeam',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
    onbStart: 'เริ่มใช้งาน',
    onbStepAria: 'หน้า {n} จาก {total}',
    onbTitle3: 'ฟรีสำหรับทุกคน',
    onbBody3: 'ไม่มีค่าลิขสิทธิ์ ไม่มีโฆษณา ไม่มีลายน้ำ',    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    navRecent: 'Terbaru',
    navStarred: 'Berbintang',    cloudSubtitle:
    ...
    cloudRefresh: 'Segarkan',    cloudEmpty: 'Belum ada proyek web.',
    ...
    noContent: '(kosong)',
    // Account    account: 'Akun',            waitingShort: 'Menunggu…',                            appVersion: 'Versi {v}',
    versionLabel: 'Versi',
    ...
    settings: 'Pengaturan',    setSecGeneral: 'Umum',
    setSecAbout: 'Tentang',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'Kosongkan untuk endpoint resmi.',    setAiCodexPath: 'Berkas eksekusi Codex',
    ...
    setSecAiMedia: 'Media & Pencarian AI',    setAiImageModel: 'Model gambar',
    setAiAnalysisModel: 'Model analisis',    setAiSearchSerperHint: 'Serper menyediakan pencarian web dan gambar dengan kunci Anda.',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      'Kunci dan Base URL satu penyedia dipakai bersama oleh semua kemampuan; cukup isi sekali.',    setAiGskToolsDesc:
    ...
    onbStarHint: 'Jika Anda menyukai GenOffice, beri kami bintang di GitHub.',        setChange: 'Ubah',
    // Dates
    today: 'Hari ini',
    yesterday: 'Kemarin',
    daysAgo: '{n} hari lalu',
    ...
    onbBody2:
      'GenOffice masih dalam tahap alpha. Gabung obrolan grup di GenTeam untuk berbagi masukan dan ikut menentukan arah ke depan.',    onbJoinGenTeam: 'Gabung GenTeam',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
    onbStepAria: 'Halaman {n} dari {total}',
    onbTitle3: 'Gratis untuk semua',
    onbBody3: 'Tanpa biaya lisensi. Tanpa iklan. Tanpa watermark.',    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    navRecent: 'Недавние',
    navStarred: 'Избранное',    cloudSubtitle:
    ...
    cloudRefresh: 'Обновить',    cloudEmpty: 'Пока нет веб-проектов.',
    ...
    noContent: '(пусто)',
    // Account    account: 'Учётная запись',            waitingShort: 'Ожидание…',                            appVersion: 'Версия {v}',
    versionLabel: 'Версия',
    ...
    settings: 'Настройки',    setSecGeneral: 'Общие',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'Оставьте пустым для официальной конечной точки.',    setAiCodexPath: 'Исполняемый файл Codex',
    setAiCodexPathHint:
    ...
    setSecAiMedia: 'Медиа и поиск ИИ',    setAiImageModel: 'Модель изображений',
    setAiAnalysisModel: 'Модель анализа',    setAiSearchSerperHint: 'Serper обеспечивает веб-поиск и поиск изображений с вашим ключом.',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      'Ключ и базовый URL провайдера общие для всех функций; введите их один раз.',    setAiGskToolsDesc:
    ...
    onbStarHint: 'Если вам нравится GenOffice, поставьте нам звезду на GitHub.',        setChange: 'Изменить',
    // Dates
    today: 'Сегодня',
    yesterday: 'Вчера',
    daysAgo: '{n} дн. назад',
    ...
    onbBody2:
      'GenOffice пока в альфа-версии. Присоединяйтесь к групповому чату в GenTeam, чтобы делиться отзывами и влиять на дальнейшее развитие.',    onbJoinGenTeam: 'Присоединиться к GenTeam',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
    onbStepAria: 'Страница {n} из {total}',
    onbTitle3: 'Бесплатно для всех',
    onbBody3: 'Без лицензий. Без рекламы. Без водяных знаков.',    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    navRecent: 'الأخيرة',
    navStarred: 'المفضلة',    cloudSubtitle:
    ...
    cloudRefresh: 'تحديث',    cloudEmpty: 'لا توجد مشاريع على الويب بعد.',
    ...
    untitled: 'بدون عنوان',
    noContent: '(فارغ)',
    // Account    account: 'الحساب',            waitingShort: 'في الانتظار…',                            appVersion: 'الإصدار {v}',
    ...
    settings: 'الإعدادات',    setSecGeneral: 'عام',
    setSecAbout: 'حول',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'اتركه فارغًا لاستخدام نقطة النهاية الرسمية.',    setAiCodexPath: 'ملف Codex التنفيذي',
    ...
    setSecAiMedia: 'وسائط الذكاء الاصطناعي والبحث',    setAiImageModel: 'نموذج الصور',
    setAiAnalysisModel: 'نموذج التحليل',    setAiSearchSerperHint: 'يوفّر Serper البحث في الويب والصور بمفتاحك.',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      'مفتاح المزوّد وعنوان Base URL مشتركان بين جميع القدرات؛ أدخلهما مرة واحدة فقط.',    setAiGskToolsDesc:
    ...
    onbStarHint: 'إذا أعجبك GenOffice، ضع لنا نجمة على GitHub.',        setChange: 'تغيير',
    // Dates
    today: 'اليوم',
    yesterday: 'أمس',
    daysAgo: 'قبل {n} أيام',
    ...
    onbBody2:
      'لا يزال GenOffice في مرحلة ألفا. انضم إلى الدردشة الجماعية على GenTeam لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',    onbJoinGenTeam: 'الانضمام إلى GenTeam',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
    onbStepAria: 'الصفحة {n} من {total}',
    onbTitle3: 'مجاني للجميع',
    onbBody3: 'بلا رسوم ترخيص، بلا إعلانات، بلا علامات مائية.',    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    navStarred: 'Favoritos',    cloudSubtitle:
    ...
    cloudRefresh: 'Atualizar',    cloudEmpty: 'Ainda não há projetos na web.',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',    account: 'Conta',            waitingShort: 'Aguardando…',                            appVersion: 'Versão {v}',
    versionLabel: 'Versão',
    ...
    settings: 'Configurações',    setSecGeneral: 'Geral',
    setSecAbout: 'Sobre',
    setSecAiModel: 'Modelo de IA',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'Deixe vazio para o endpoint oficial.',    setAiCodexPath: 'Executável do Codex',
    setAiCodexPathHint:
    ...
    setSecAiMedia: 'Mídia e busca de IA',    setAiImageModel: 'Modelo de imagem',
    setAiAnalysisModel: 'Modelo de análise',    setAiSearchSerperHint: 'O Serper oferece busca na web e de imagens com a sua chave.',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      'A chave e a URL base de um provedor são compartilhadas entre as capacidades; insira-as uma só vez.',    setAiGskToolsDesc:
    ...
    onbStarHint: 'Se você gosta do GenOffice, deixe uma estrela no GitHub.',        setChange: 'Alterar',
    today: 'Hoje',
    yesterday: 'Ontem',
    daysAgo: 'há {n} dias',
    language: 'Idioma',
    ...
    onbBody2:
      'O GenOffice ainda está em alfa. Entre no chat em grupo no GenTeam para compartilhar feedback e ajudar a moldar o que vem a seguir.',    onbJoinGenTeam: 'Entrar no GenTeam',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
    onbTitle3: 'Gratuito para todos',
    onbBody3: "Sem licenças. Sem anúncios. Sem marcas d'água.",    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    navStarred: 'Preferiti',    cloudSubtitle:
    ...
    cloudRefresh: 'Aggiorna',    cloudEmpty: 'Ancora nessun progetto web.',
    ...
    noContent: '(vuoto)',    account: 'Account',        
    
    waitingShort: 'In attesa…',                            appVersion: 'Versione {v}',
    ...
    settings: 'Impostazioni',    setSecGeneral: 'Generale',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: "Lascia vuoto per l'endpoint ufficiale.",    setAiCodexPath: 'Eseguibile Codex',
    setAiCodexPathHint:
    ...
    setSecAiMedia: 'Media e ricerca IA',    setAiImageModel: 'Modello immagini',
    setAiAnalysisModel: 'Modello di analisi',    setAiSearchSerperHint: 'Serper offre ricerca web e di immagini con la tua chiave.',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      "La chiave e l'URL base di un provider sono condivisi tra le capacità; inseriscili una volta sola.",    setAiGskToolsDesc:
    ...
    onbStarHint: 'Se ti piace GenOffice, lasciaci una stella su GitHub.',        setChange: 'Cambia',
    today: 'Oggi',
    yesterday: 'Ieri',
    daysAgo: '{n} giorni fa',
    language: 'Lingua',
    ...
    onbBody2:
      'GenOffice è ancora in alpha. Unisciti alla chat di gruppo su GenTeam per condividere feedback e contribuire a plasmare il futuro.',    onbJoinGenTeam: 'Unisciti a GenTeam',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
    onbStepAria: 'Pagina {n} di {total}',
    onbTitle3: 'Gratuito per tutti',
    onbBody3: 'Nessuna licenza. Nessuna pubblicità. Nessuna filigrana.',    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    navStarred: 'Ulubione',    cloudSubtitle:
    ...
    cloudRefresh: 'Odśwież',    cloudEmpty: 'Brak projektów w sieci.',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',    account: 'Konto',            waitingShort: 'Oczekiwanie…',                            appVersion: 'Wersja {v}',
    versionLabel: 'Wersja',
    ...
    settings: 'Ustawienia',    setSecGeneral: 'Ogólne',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'Pozostaw puste, aby użyć oficjalnego punktu końcowego.',    setAiCodexPath: 'Plik wykonywalny Codex',
    setAiCodexPathHint:
    ...
    setSecAiMedia: 'Media i wyszukiwanie AI',    setAiImageModel: 'Model obrazów',
    setAiAnalysisModel: 'Model analizy',    setAiSearchSerperHint: 'Serper zapewnia wyszukiwanie w sieci i obrazów z Twoim kluczem.',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      'Klucz i bazowy URL dostawcy są wspólne dla wszystkich funkcji; wpisz je raz.',    setAiGskToolsDesc:
    ...
    onbStarHint: 'Jeśli podoba Ci się GenOffice, zostaw nam gwiazdkę na GitHubie.',        setChange: 'Zmień',
    today: 'Dzisiaj',
    yesterday: 'Wczoraj',
    daysAgo: '{n} dni temu',
    language: 'Język',
    ...
    onbBody2:
      'GenOffice jest wciąż w fazie alfa. Dołącz do czatu grupowego na GenTeam, aby dzielić się opiniami i współtworzyć jego przyszłość.',    onbJoinGenTeam: 'Dołącz do GenTeam',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
    onbStepAria: 'Strona {n} z {total}',
    onbTitle3: 'Za darmo dla każdego',
    onbBody3: 'Bez opłat licencyjnych. Bez reklam. Bez znaków wodnych.',    onbBack: 'Wstecz',
  },
  cs: {
    navRecent: 'Nedávné',
    navStarred: 'Oblíbené',    cloudSubtitle:
    ...
    cloudRefresh: 'Obnovit',    cloudEmpty: 'Zatím žádné webové projekty.',
    ...
    untitled: 'Bez názvu',
    noContent: '(prázdné)',    account: 'Účet',                            
    ...
    settings: 'Nastavení',    setSecGeneral: 'Obecné',
    ...
    setAiBaseUrlHint: 'Pro oficiální koncový bod ponechte prázdné.',    setAiCodexPath: 'Spustitelný soubor Codex',
    setAiCodexPathHint:
    ...
    setSecAiMedia: 'AI média a vyhledávání',    setAiImageModel: 'Model pro obrázky',
    setAiAnalysisModel: 'Model pro analýzu',    setAiSearchSerperHint: 'Serper zajišťuje webové i obrázkové vyhledávání s vaším klíčem.',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      'Klíč a základní URL jednoho poskytovatele se sdílejí mezi funkcemi; zadejte je jen jednou.',    setAiGskToolsDesc:
    ...
    onbStarHint: 'Pokud se vám GenOffice líbí, dejte nám hvězdičku na GitHubu.',        setChange: 'Změnit',
    today: 'Dnes',
    yesterday: 'Včera',
    daysAgo: 'před {n} dny',
    language: 'Jazyk',
    ...
    onbBody2:
      'GenOffice je stále ve fázi alfa. Připojte se ke skupinovému chatu na GenTeam, sdílejte zpětnou vazbu a pomozte utvářet, co přijde dál.',    onbJoinGenTeam: 'Připojit se ke GenTeam',
    onbSkip: 'Přeskočit',
    onbNext: 'Další',
    onbStart: 'Začít',
    onbStepAria: 'Stránka {n} z {total}',
    onbTitle3: 'Zdarma pro všechny',
    onbBody3: 'Žádné licenční poplatky. Žádné reklamy. Žádné vodoznaky.',    onbBack: 'Zpět',
  ...
  nl: {
    navRecent: 'Recent',
    navStarred: 'Favorieten',    cloudSubtitle:
    ...
    cloudRefresh: 'Vernieuwen',    cloudEmpty: 'Nog geen webprojecten.',
    ...
    untitled: 'Naamloos',
    noContent: '(leeg)',    account: 'Account',            waitingShort: 'Wachten…',                            appVersion: 'Versie {v}',
    versionLabel: 'Versie',
    ...
    settings: 'Instellingen',    setSecGeneral: 'Algemeen',
    setSecAbout: 'Over',
    setSecAiModel: 'AI-model',
    setAiProvider: 'Provider',
    setAiModelId: 'Model',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'Leeg laten voor het officiële eindpunt.',    setAiCodexPath: 'Codex-uitvoerbaar bestand',
    setAiCodexPathHint:
    ...
    setSecAiMedia: 'AI-media en zoeken',    setAiImageModel: 'Afbeeldingsmodel',
    setAiAnalysisModel: 'Analysemodel',    setAiSearchSerperHint: 'Serper levert web- en afbeeldingszoeken met je sleutel.',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      'De sleutel en basis-URL van een provider gelden voor alle functies; één keer invoeren volstaat.',    setAiGskToolsDesc:
    ...
    onbStarHint: 'Als GenOffice je bevalt, geef ons dan een ster op GitHub.',        setChange: 'Wijzigen',
    today: 'Vandaag',
    yesterday: 'Gisteren',
    ...
    onbBody2:
      'GenOffice is nog in alfa. Doe mee aan de groepschat op GenTeam om feedback te delen en mee te bepalen wat er komt.',    onbJoinGenTeam: 'Word lid van GenTeam',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
    onbStart: 'Aan de slag',
    onbStepAria: 'Pagina {n} van {total}',
    onbTitle3: 'Gratis voor iedereen',
    onbBody3: 'Geen licentiekosten. Geen advertenties. Geen watermerken.',    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    navStarred: 'Berbintang',    cloudSubtitle:
    ...
    cloudSortRecent: 'Terbaru',
    cloudSortOldest: 'Terlama',
    cloudRefresh: 'Muat semula',    cloudEmpty: 'Belum ada projek web.',
    ...
    noContent: '(kosong)',    account: 'Akaun',            waitingShort: 'Menunggu…',                            appVersion: 'Versi {v}',
    versionLabel: 'Versi',
    ...
    settings: 'Tetapan',    setSecGeneral: 'Umum',
    setSecAbout: 'Perihal',
    setSecAiModel: 'Model AI',
    setAiProvider: 'Penyedia',
    setAiModelId: 'Model',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'Biarkan kosong untuk endpoint rasmi.',    setAiCodexPath: 'Fail boleh laku Codex',
    setAiCodexPathHint:
    ...
    setSecAiMedia: 'Media & Carian AI',    setAiImageModel: 'Model imej',
    setAiAnalysisModel: 'Model analisis',    setAiSearchSerperHint: 'Serper menyediakan carian web dan imej dengan kunci anda.',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      'Kunci dan Base URL pembekal dikongsi oleh semua keupayaan; isi sekali sahaja.',    setAiGskToolsDesc:
    ...
    onbStarHint: 'Jika anda suka GenOffice, beri kami bintang di GitHub.',        setChange: 'Tukar',
    today: 'Hari ini',
    yesterday: 'Semalam',
    daysAgo: '{n} hari lalu',
    language: 'Bahasa',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'GenOffice masih dalam peringkat alfa. Sertai sembang kumpulan di GenTeam untuk berkongsi maklum balas dan membentuk masa depannya.',    onbJoinGenTeam: 'Sertai GenTeam',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
    onbStepAria: 'Halaman {n} daripada {total}',
    onbTitle3: 'Percuma untuk semua',
    onbBody3: 'Tiada yuran lesen. Tiada iklan. Tiada tera air.',    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    navStarred: 'מועדפים',    cloudSubtitle:
    ...
    cloudRefresh: 'רענון',    cloudEmpty: 'אין עדיין פרויקטים מהאתר.',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',    account: 'חשבון',            waitingShort: 'ממתין…',                            appVersion: 'גרסה {v}',
    versionLabel: 'גרסה',
    ...
    settings: 'הגדרות',    setSecGeneral: 'כללי',
    setSecAbout: 'אודות',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'השאר ריק לנקודת הקצה הרשמית.',    setAiCodexPath: 'קובץ ההפעלה של Codex',
    ...
    setSecAiMedia: 'מדיה וחיפוש AI',    setAiImageModel: 'מודל תמונות',
    setAiAnalysisModel: 'מודל ניתוח',    setAiSearchSerperHint: 'Serper מספק חיפוש באינטרנט ובתמונות עם המפתח שלך.',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      'המפתח וכתובת ה-Base URL של ספק משותפים לכל היכולות; יש להזין אותם פעם אחת בלבד.',    setAiGskToolsDesc:
    ...
    onbStarHint: 'אם GenOffice מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',        setChange: 'שינוי',
    today: 'היום',
    yesterday: 'אתמול',
    daysAgo: 'לפני {n} ימים',
    language: 'שפה',
    ...
    onbBody2:
      'GenOffice עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-GenTeam כדי לשתף משוב ולעזור לעצב את ההמשך.',    onbJoinGenTeam: 'הצטרפו ל-GenTeam',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
    onbStepAria: 'עמוד {n} מתוך {total}',
    onbTitle3: 'חינם לכולם',
    onbBody3: 'ללא דמי רישיון, ללא פרסומות, ללא סימני מים.',    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    navStarred: 'तारांकित',    cloudSubtitle:
    ...
    cloudRefresh: 'रीफ़्रेश',    cloudEmpty: 'अभी तक कोई वेब प्रोजेक्ट नहीं है।',
    ...
    noContent: '(खाली)',    account: 'खाता',            waitingShort: 'प्रतीक्षा में…',                            appVersion: 'संस्करण {v}',
    ...
    settings: 'सेटिंग्स',    setSecGeneral: 'सामान्य',
    setSecAbout: 'जानकारी',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'आधिकारिक एंडपॉइंट के लिए खाली छोड़ें।',    setAiCodexPath: 'Codex निष्पादन फ़ाइल',
    ...
    setSecAiMedia: 'AI मीडिया और खोज',    setAiImageModel: 'इमेज मॉडल',
    setAiAnalysisModel: 'विश्लेषण मॉडल',    setAiSearchSerperHint: 'Serper आपकी कुंजी से वेब और इमेज खोज दोनों देता है।',
    setAiSearchTavilyHint:
    ...
    setAiSharedKeyHint:
      'एक प्रदाता की कुंजी और Base URL सभी क्षमताओं में साझा होते हैं; एक बार ही दर्ज करें।',    setAiGskToolsDesc:
    ...
    onbStarHint: 'अगर आपको GenOffice पसंद है, तो हमें GitHub पर स्टार दें।',        setChange: 'बदलें',
    today: 'आज',
    yesterday: 'कल',
    daysAgo: '{n} दिन पहले',
    language: 'भाषा',
    ...
    onbBody2:
      'GenOffice अभी अल्फ़ा में है। GenTeam पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',    onbJoinGenTeam: 'GenTeam से जुड़ें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
    onbStepAria: 'कुल {total} में से पृष्ठ {n}',
    onbTitle3: 'सभी के लिए मुफ़्त',
    onbBody3: 'कोई लाइसेंस शुल्क नहीं। कोई विज्ञापन नहीं। कोई वॉटरमार्क नहीं।',    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    navStarred: '收藏',    cloudSearchPlaceholder: '搜尋 {n} 個專案…',
    ...
    cloudSortRecent: '最近',
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',    cloudEmpty: '還沒有網頁端專案。',
    ...
    untitled: '未命名',
    noContent: '（無內容）',    account: '帳號',            waitingShort: '等待登入…',                            appVersion: '版本 {v}',
    versionLabel: '版本',
    updateChannel: '更新通道',
    channelStable: '穩定版',
    channelBeta: 'Beta 版',
    ...
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: '留空使用官方端點。',    setAiCodexPath: 'Codex 可執行檔',
    ...
    setSecAiMedia: '生圖、媒體與搜尋',    setAiImageModel: '生圖模型',
    setAiAnalysisModel: '解析模型',    setAiSearchSerperHint: 'Serper 用你的 key 同時提供網頁與圖片搜尋。',
    setAiSearchTavilyHint: 'Tavily 用你的 key 提供網頁搜尋；圖片搜尋改用免費來源。',
    setAiCapImage: '生圖',
    setAiCapAnalysis: '圖片解析',
    setAiCapVideo: '影片解析',
    setAiCapSearch: '網路搜尋',
    setAiSharedKeyHint: '同一服務商的 key 與 Base URL 在各項能力間共用，只需填一次。',    setAiGskToolsDesc:
    ...
    onbStarHint: '如果你喜歡 GenOffice，歡迎到 GitHub 給我們一顆星。',        setChange: '變更',
    today: '今天',
    yesterday: '昨天',
    daysAgo: '{n} 天前',
    language: '語言',
    ...
    onbTitle2: '這只是一個開始',
    onbBody2: 'GenOffice 目前仍在 alpha 階段。歡迎加入 GenTeam 群聊，分享回饋，一起打造它的未來。',    onbJoinGenTeam: '加入 GenTeam',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
    onbStepAria: '第 {n} 頁，共 {total} 頁',
    onbTitle3: '人人免費',
    onbBody3: '無授權費用，無廣告，無浮水印。',    onbBack: '上一步',
  },
} as const
