...
export interface HomeApi {
  ...
  /** Claude Code model catalog (hardcoded Claude family; the local CLI login supplies the default) */
  getClaudeCodeModels(cliPath?: string): Promise<CodexModelCatalog>
