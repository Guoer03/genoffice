...
/// retries turn most transient CDN failures into successful inserts.
 ...
 * and retries on transient failures (network errors, 403/408/429, 5xx).
 * An SSRF-blocked URL still returns null immediately — that outcome never
 * changes on retry.
 */
